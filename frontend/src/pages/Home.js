    ...
    <>
      ...
      <div className='content'>
        <div className='box'>
          ...
          <p>
            "Working with Gabriel Castro has been a game-changer for our
            business. The new website is not only beautiful but also incredibly
            functional. We’ve seen a significant increase in traffic and
            engagement." - <em>Happy Client</em>
          </p>
          <p>
            "The professional approach and expertise Gabriel Castro brought to
            the table made the entire development process smooth and efficient.
